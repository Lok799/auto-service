...
// ============================================================
//  Заполнение "на основании" (конструктор ввода на основании)
// ============================================================
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
    ...
    Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ЗаказНаряд") Тогда
        ...
        НомерЗаказа = ЗаказНаряд.Номер;
        ДатаЗаказа = Формат(ЗаказНаряд.Дата, "ДЛФ=DD.MM.YYYY");
...
Процедура ОбработкаПроведения(Отказ, Режим)
    ...
    // Устанавливаем исключительную блокировку по измерениям Номенклатура и Склад
    // на время проведения, чтобы избежать одновременного списания одних и тех же остатков.
